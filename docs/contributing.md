...
Note that if you are releasing a new major version, you should bump the peer dependency `@visma/rjsf-core` in the `package.json` files of other packages accordingly.
